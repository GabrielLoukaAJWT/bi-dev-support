...
class MainWindow:
    ...
    def setupMainUI(self) -> None:
        ...
        self.version_label = ttk.Label(self.mainFrame, text=f"{cta.APP_TITLE} v1.5.0", anchor="e", style="MainVersionLabel.TLabel")
